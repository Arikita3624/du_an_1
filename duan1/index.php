...
try {
    match ($act) {
        ...
        'remove-from-cart' => (new CartsController())->removeFromCart(),
        'clear-cart' => (new CartsController())->clearCart(),
        'checkout' => (new CheckoutController())->index(),
        'login' => (new SignInController())->index(),
        'register' => (new SignUpController())->index(),
        'add-to-compare' => (new CompareController())->addToCompare(),
        'remove-from-compare' => (new CompareController())->removeFromCompare(),
